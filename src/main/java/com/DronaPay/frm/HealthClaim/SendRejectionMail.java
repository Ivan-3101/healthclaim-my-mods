...
//        Change id from from 5...10 to 11...15 --> as it had already had other templates in this id
        ...
        log.info("Sending rejection email with templateId: " + templateId + " for tenantId: " + tenantId);
